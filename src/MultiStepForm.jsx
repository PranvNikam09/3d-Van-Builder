...
const MultiStepForm = ({
  ...
  const toggleModelSelection = (model) => {
    ...
    let storageKey;
    if (activeTab === "interior") {
      storageKey = "selectedInteriorModels";
    } else if (activeTab === "exterior") {
      storageKey = "selectedExteriorModels";
    } else {
      storageKey = "selectedSystemModels";
    }
  ...
  return (
    <div className="main-content d-flex flex-column position-relative">
      {/* Tab Buttons */}
      <div className="d-flex justify-content-center gap-2 pt-2 pb-2 bg-secondary shadow-sm sticky-top" style={{zIndex:2}}>
        {[
          ...
          <button
            key={tab.key}
            className={`btn px-3 py-2 fw-semibold shadow-sm position-relative tab-btn${activeTab === tab.key ? " active" : ""}`}
          ...
          >
            ...
            {tab.label}
            {activeTab === tab.key && (
              <span className="position-absolute top-0 start-100 translate-middle rounded-pill bg-success selected-indicator" aria-label="Selected">
      ...
      <div className="sticky-bottom-nav bg-white text-dark p-3 shadow-lg">
        <div className="d-flex justify-content-between align-items-center flex-wrap gap-2">
          ...
          {activeTab === "exterior" && currentStep === 0 ? (
            <button
              className="btn px-4 py-2 fw-semibold btn-nav-alt"
              onClick={() => {
            ...
            >
              <i className="bi bi-arrow-left me-2"></i> Interior
            </button>
            ...
            <button
              className="btn px-4 py-2 fw-semibold btn-nav"
          ...
          {activeTab === "interior" && currentStep === steps.length - 1 ? (
            <button
              className="btn px-4 py-2 fw-semibold btn-next"
              onClick={() => {
                toggleExterior(true);
                setActiveTab("exterior");
                setCurrentStep(0);
            ...
            <button
              className="btn px-4 py-2 fw-semibold btn-done"
              disabled
            >
               Done
            </button>
        ...
        <div className="text-center mt-3">
          <button
            className="btn btn-success btn-lg px-5 py-3 fw-bold shadow-sm w-100 btn-quote"
